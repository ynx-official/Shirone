...
const siteConfig = { imageOptimization: { noReferrerDomains: [] } };
const i18n = (key) => ({ fieldRequired: "Required", fieldOptional: "Optional", fieldDeprecated: "Deprecated" })[key] ?? key;
