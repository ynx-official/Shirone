...
export const vi: Translation = {
  ...
  [Key.explore]: "Khám phá",
  [Key.theme]: "Giao diện",
  [Key.skipContent]: "Đến nội dung",
  [Key.localNotice]: "Bản thử cục bộ. Thay đổi chỉ ảnh hưởng trình duyệt này.",
  [Key.saveLocal]: "Lưu cục bộ",
  [Key.savedLocal]: "Đã lưu cục bộ",
  [Key.preview]: "Xem trước",
  [Key.exportData]: "Xuất JSON",
  [Key.importData]: "Nhập JSON",
  [Key.resetData]: "Đặt lại dữ liệu",
  [Key.newItem]: "Tạo mới",
  [Key.deleteItem]: "Xóa",
  [Key.edit]: "Sửa",
  [Key.title]: "Tiêu đề",
  ...
  [Key.draft]: "Bản nháp",
  [Key.published]: "Đã xuất bản (thử)",
  [Key.settings]: "Cài đặt",
  [Key.overview]: "Tổng quan",
  [Key.media]: "Phương tiện",
  [Key.upload]: "Tải ảnh lên",
  [Key.dataTools]: "Công cụ dữ liệu",
  [Key.saveError]: "Không thể lưu. Kiểm tra bộ nhớ.",
  [Key.invalidData]: "Dữ liệu không hợp lệ; dữ liệu cũ không thay đổi.",
  [Key.confirmDelete]: "Xóa mục? Hãy cập nhật tham chiếu trước.",
  [Key.confirmReset]: "Đặt lại mọi chỉnh sửa và ảnh cục bộ?",
  [Key.password]: "Mật khẩu",
  [Key.unlock]: "Mở khóa",
  [Key.unlockError]: "Sai mật khẩu",
  [Key.empty]: "Không có mục",
  [Key.back]: "Quay lại",
  [Key.next]: "Tiếp",
  [Key.previous]: "Trước",
  [Key.searchPlaceholder]: "Tìm bài viết…",
  [Key.localOnly]: "Chỉ xem trước cục bộ",
  [Key.storage]: "Bộ nhớ",
  ...
  [Key.searchError]: "Không thể tìm kiếm. Vui lòng thử lại.",
  [Key.enable]: "Bật",
  [Key.progress]: "Tiến trình",
  [Key.adminContent]: "Nội dung",
  [Key.adminOrganize]: "Tổ chức",
  [Key.adminMediaDescription]: "Quản lý ảnh cục bộ được dùng trong nội dung.",
  [Key.adminUploadHint]:
    "JPG, PNG, GIF, WebP hoặc AVIF, tối đa 20 MB. Tự động tải lên.",
  [Key.adminChooseImages]: "Chọn ảnh",
  [Key.adminCleanUnused]: "Xóa ảnh chưa sử dụng",
  [Key.adminCleanConfirm]:
    "Xóa tất cả ảnh cục bộ chưa được tham chiếu? Không thể hoàn tác.",
  [Key.adminReferenced]: "Không thể xóa ảnh đang sử dụng",
  [Key.adminReferenceCount]: "Được dùng bởi {count} mục",
  [Key.adminOverviewIntro]: "Tổng quan nội dung của bạn.",
  [Key.adminRecentHint]: "Bài viết theo ngày nội dung.",
  [Key.adminQuickActions]: "Thao tác nhanh",
  [Key.adminModuleHint]: "Quản lý phân loại và trang",
  [Key.adminMediaSearch]: "Tìm tên tệp",
  [Key.adminGridView]: "Dạng lưới",
  [Key.adminListView]: "Dạng danh sách",
  [Key.adminMediaTotal]: "{count} ảnh",
  [Key.adminCopyReference]: "Sao chép tham chiếu",
};
