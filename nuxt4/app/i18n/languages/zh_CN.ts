...
export const zh_CN: Translation = {
  ...
  [Key.styleTonalSpot]: "柔和色调",
  [Key.styleVibrant]: "鲜明",
  [Key.styleContent]: "内容配色",
  [Key.styleExpressive]: "表现力",
  [Key.styleRainbow]: "彩虹",
  [Key.styleFruitSalad]: "缤纷果色",
  [Key.styleMonochrome]: "单色",
  [Key.styleNeutral]: "中性",
  [Key.styleFidelity]: "忠实原色",
  ...
  [Key.resetConfirmMessage]: "将恢复为站点默认的色相、配色风格与配色规范。",
  ...
  [Key.explore]: "探索",
  [Key.theme]: "主题",
  [Key.skipContent]: "跳至正文",
  [Key.localNotice]: "本地演示：修改仅影响当前浏览器，公开站点保持不变。",
  [Key.saveLocal]: "保存到本地",
  [Key.savedLocal]: "已保存到本地",
  [Key.preview]: "预览",
  [Key.exportData]: "导出 JSON",
  [Key.importData]: "导入 JSON",
  [Key.resetData]: "重置数据",
  [Key.newItem]: "新建",
  [Key.deleteItem]: "删除",
  [Key.edit]: "编辑",
  [Key.title]: "标题",
  [Key.description]: "描述",
  [Key.body]: "Markdown 正文",
  [Key.date]: "日期",
  [Key.status]: "状态",
  [Key.draft]: "草稿",
  [Key.published]: "已发布（演示）",
  [Key.settings]: "设置",
  [Key.overview]: "概览",
  [Key.media]: "媒体",
  [Key.upload]: "上传图片",
  [Key.dataTools]: "数据工具",
  [Key.saveError]: "保存失败，请检查浏览器存储。",
  [Key.invalidData]: "数据无效，原有数据未改变。",
  [Key.confirmDelete]: "删除此项？请先处理引用关系。",
  [Key.confirmReset]: "重置全部本地修改与媒体？",
  [Key.password]: "密码",
  [Key.unlock]: "解锁",
  [Key.unlockError]: "密码错误",
  [Key.empty]: "暂无内容",
  [Key.back]: "返回",
  [Key.next]: "下一页",
  [Key.previous]: "上一页",
  [Key.searchPlaceholder]: "搜索文章…",
  [Key.localOnly]: "仅本地预览",
  [Key.storage]: "存储",
  [Key.details]: "详情",
  [Key.add]: "添加",
  ...
  [Key.homeLink]: "返回首页",
  [Key.selectItem]: "选择条目",
  [Key.sourceData]: "结构化数据",
  [Key.localeName]: "简体中文",
  [Key.locale]: "语言",
  [Key.cancel]: "取消",
  [Key.copyCode]: "复制代码",
  [Key.searchError]: "搜索暂不可用，请重试。",
  [Key.enable]: "启用",
  [Key.progress]: "进度",
  [Key.adminContent]: "内容",
  [Key.adminOrganize]: "组织",
  [Key.adminMediaDescription]: "管理正文图片；上传的图片保存在当前浏览器中。",
  [Key.adminUploadHint]:
    "JPG、PNG、GIF、WebP 或 AVIF，最大 20 MB；选择后自动上传。",
  [Key.adminChooseImages]: "选择图片",
  [Key.adminCleanUnused]: "清理未引用图片",
  [Key.adminCleanConfirm]: "删除所有未引用的本地图片？此操作无法撤销。",
  [Key.adminReferenced]: "使用中的图片不能删除",
  [Key.adminReferenceCount]: "引用 {count} 项",
  [Key.adminOverviewIntro]: "查看内容近况，继续你的创作。",
  [Key.adminRecentHint]: "按内容日期查看近期文章。",
  [Key.adminQuickActions]: "常用操作",
  [Key.adminModuleHint]: "管理内容分类与扩展页面",
  [Key.adminMediaSearch]: "搜索文件名",
  [Key.adminGridView]: "网格视图",
  [Key.adminListView]: "列表视图",
  [Key.adminMediaTotal]: "共 {count} 张图片",
  [Key.adminCopyReference]: "复制引用",
};
