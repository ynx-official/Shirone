...
export const ko: Translation = {
  ...
  [Key.explore]: "둘러보기",
  [Key.theme]: "테마",
  [Key.skipContent]: "본문으로",
  [Key.localNotice]: "로컬 데모입니다. 변경은 현재 브라우저에만 적용됩니다.",
  [Key.saveLocal]: "로컬 저장",
  [Key.savedLocal]: "로컬에 저장됨",
  [Key.preview]: "미리보기",
  [Key.exportData]: "JSON 내보내기",
  [Key.importData]: "JSON 가져오기",
  [Key.resetData]: "데이터 초기화",
  [Key.newItem]: "새 항목",
  [Key.deleteItem]: "삭제",
  [Key.edit]: "편집",
  [Key.title]: "제목",
  [Key.description]: "설명",
  [Key.body]: "Markdown 본문",
  [Key.date]: "날짜",
  [Key.status]: "상태",
  [Key.draft]: "초안",
  [Key.published]: "게시됨(데모)",
  [Key.settings]: "설정",
  [Key.overview]: "개요",
  [Key.media]: "미디어",
  [Key.upload]: "이미지 업로드",
  [Key.dataTools]: "데이터 도구",
  [Key.saveError]: "저장 실패. 저장 공간을 확인하세요.",
  [Key.invalidData]: "잘못된 데이터입니다. 기존 데이터는 변경되지 않았습니다.",
  [Key.confirmDelete]: "삭제할까요? 먼저 참조를 수정하세요.",
  [Key.confirmReset]: "로컬 수정과 미디어를 초기화할까요?",
  [Key.password]: "비밀번호",
  [Key.unlock]: "잠금 해제",
  [Key.unlockError]: "잘못된 비밀번호",
  [Key.empty]: "항목 없음",
  [Key.back]: "뒤로",
  [Key.next]: "다음",
  [Key.previous]: "이전",
  [Key.searchPlaceholder]: "글 검색…",
  [Key.localOnly]: "로컬 미리보기 전용",
  [Key.storage]: "저장 공간",
  [Key.details]: "상세",
  [Key.add]: "추가",
  [Key.remove]: "제거",
  [Key.notFound]: "페이지를 찾을 수 없음",
  [Key.homeLink]: "홈으로",
  ...
  [Key.cancel]: "취소",
  [Key.copyCode]: "코드 복사",
  [Key.searchError]: "검색할 수 없습니다. 다시 시도하세요.",
  [Key.enable]: "활성화",
  [Key.progress]: "진행",
  [Key.adminContent]: "콘텐츠",
  [Key.adminOrganize]: "정리",
  [Key.adminMediaDescription]: "콘텐츠에 사용하는 로컬 이미지를 관리합니다.",
  [Key.adminUploadHint]:
    "JPG, PNG, GIF, WebP 또는 AVIF, 최대 20 MB. 선택하면 자동 업로드됩니다.",
  [Key.adminChooseImages]: "이미지 선택",
  [Key.adminCleanUnused]: "미사용 이미지 삭제",
  [Key.adminCleanConfirm]:
    "참조되지 않은 로컬 이미지를 모두 삭제할까요? 되돌릴 수 없습니다.",
  [Key.adminReferenced]: "사용 중인 이미지는 삭제할 수 없습니다",
  [Key.adminReferenceCount]: "{count}개 항목에서 사용",
  [Key.adminOverviewIntro]: "콘텐츠 현황을 확인하고 창작을 이어가세요.",
  [Key.adminRecentHint]: "콘텐츠 날짜순으로 표시합니다.",
  [Key.adminQuickActions]: "빠른 작업",
  [Key.adminModuleHint]: "분류 및 추가 페이지 관리",
  [Key.adminMediaSearch]: "파일 이름 검색",
  [Key.adminGridView]: "격자 보기",
  [Key.adminListView]: "목록 보기",
  [Key.adminMediaTotal]: "이미지 {count}개",
  [Key.adminCopyReference]: "참조 복사",
};
