...
export const es: Translation = {
  ...
  [Key.manage]: "Administrar",
  [Key.navigation]: "Navegación",
  [Key.explore]: "Explorar",
  [Key.theme]: "Tema",
  [Key.skipContent]: "Ir al contenido",
  [Key.localNotice]:
    "Demostración local. Los cambios solo afectan a este navegador.",
  [Key.saveLocal]: "Guardar localmente",
  [Key.savedLocal]: "Guardado localmente",
  [Key.preview]: "Vista previa",
  [Key.exportData]: "Exportar JSON",
  [Key.importData]: "Importar JSON",
  [Key.resetData]: "Restablecer datos",
  [Key.newItem]: "Nuevo",
  [Key.deleteItem]: "Eliminar",
  [Key.edit]: "Editar",
  [Key.title]: "Título",
  ...
  [Key.status]: "Estado",
  [Key.draft]: "Borrador",
  [Key.published]: "Publicado (demo)",
  [Key.settings]: "Ajustes",
  [Key.overview]: "Resumen",
  [Key.media]: "Medios",
  [Key.upload]: "Subir imagen",
  [Key.dataTools]: "Herramientas de datos",
  [Key.saveError]: "No se pudo guardar. Comprueba el almacenamiento.",
  [Key.invalidData]: "Datos no válidos; no se cambiaron los datos existentes.",
  [Key.confirmDelete]: "¿Eliminar? Actualiza primero las referencias.",
  [Key.confirmReset]: "¿Restablecer cambios y medios locales?",
  [Key.password]: "Contraseña",
  [Key.unlock]: "Desbloquear",
  [Key.unlockError]: "Contraseña incorrecta",
  [Key.empty]: "Sin elementos",
  [Key.back]: "Volver",
  [Key.next]: "Siguiente",
  [Key.previous]: "Anterior",
  [Key.searchPlaceholder]: "Buscar artículos…",
  [Key.localOnly]: "Solo vista previa local",
