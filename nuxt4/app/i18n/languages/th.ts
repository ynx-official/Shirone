...
export const th: Translation = {
  ...
  [Key.adminContent]: "เนื้อหา",
  [Key.adminOrganize]: "จัดระเบียบ",
  [Key.adminMediaDescription]: "จัดการรูปภาพในเบราว์เซอร์ที่ใช้ในเนื้อหา",
  [Key.adminUploadHint]:
    "JPG, PNG, GIF, WebP หรือ AVIF สูงสุด 20 MB อัปโหลดอัตโนมัติ",
  [Key.adminChooseImages]: "เลือกรูปภาพ",
  [Key.adminCleanUnused]: "ลบรูปภาพที่ไม่ได้ใช้",
  [Key.adminCleanConfirm]:
    "ลบรูปภาพในเครื่องที่ไม่มีการอ้างอิงทั้งหมดหรือไม่? ไม่สามารถเลิกทำได้",
  [Key.adminReferenced]: "ไม่สามารถลบรูปภาพที่ใช้งานอยู่",
  [Key.adminReferenceCount]: "ใช้ใน {count} รายการ",
  [Key.adminOverviewIntro]: "ดูภาพรวมเนื้อหาของคุณ",
  [Key.adminRecentHint]: "บทความเรียงตามวันที่เนื้อหา",
  [Key.adminQuickActions]: "การทำงานด่วน",
  [Key.adminModuleHint]: "จัดการหมวดหมู่และหน้าเพิ่มเติม",
  [Key.adminMediaSearch]: "ค้นหาชื่อไฟล์",
  [Key.adminGridView]: "มุมมองตาราง",
  [Key.adminListView]: "มุมมองรายการ",
  [Key.adminMediaTotal]: "รูปภาพ {count} รูป",
  [Key.adminCopyReference]: "คัดลอกการอ้างอิง",
};
