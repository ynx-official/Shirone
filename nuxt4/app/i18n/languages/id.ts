...
export const id: Translation = {
  ...
  [Key.explore]: "Jelajahi",
  [Key.theme]: "Tema",
  [Key.skipContent]: "Ke konten",
  [Key.localNotice]: "Demo lokal. Perubahan hanya berlaku di peramban ini.",
  [Key.saveLocal]: "Simpan lokal",
  [Key.savedLocal]: "Tersimpan lokal",
  [Key.preview]: "Pratinjau",
  [Key.exportData]: "Ekspor JSON",
  [Key.importData]: "Impor JSON",
  [Key.resetData]: "Atur ulang data",
  [Key.newItem]: "Baru",
  [Key.deleteItem]: "Hapus",
  [Key.edit]: "Edit",
  [Key.title]: "Judul",
  ...
  [Key.status]: "Status",
  [Key.draft]: "Draf",
  [Key.published]: "Terbit (demo)",
  [Key.settings]: "Pengaturan",
  [Key.overview]: "Ringkasan",
  [Key.media]: "Media",
  [Key.upload]: "Unggah gambar",
  [Key.dataTools]: "Alat data",
  [Key.saveError]: "Gagal menyimpan. Periksa penyimpanan.",
  [Key.invalidData]: "Data tidak valid; data lama tidak berubah.",
  [Key.confirmDelete]: "Hapus item? Perbarui referensi terlebih dahulu.",
  [Key.confirmReset]: "Atur ulang perubahan dan media lokal?",
  [Key.password]: "Kata sandi",
  [Key.unlock]: "Buka",
  [Key.unlockError]: "Kata sandi salah",
  [Key.empty]: "Tidak ada item",
  [Key.back]: "Kembali",
  [Key.next]: "Berikutnya",
  [Key.previous]: "Sebelumnya",
  [Key.searchPlaceholder]: "Cari artikel…",
  [Key.localOnly]: "Pratinjau lokal saja",
  [Key.storage]: "Penyimpanan",
  [Key.details]: "Detail",
  [Key.add]: "Tambah",
  [Key.remove]: "Singkirkan",
