...
export const tr: Translation = {
  ...
  [Key.manage]: "Yönet",
  [Key.navigation]: "Gezinme",
  [Key.explore]: "Keşfet",
  [Key.theme]: "Tema",
  [Key.skipContent]: "İçeriğe geç",
  [Key.localNotice]:
    "Yerel demo. Değişiklikler yalnızca bu tarayıcıyı etkiler.",
  [Key.saveLocal]: "Yerel kaydet",
  [Key.savedLocal]: "Yerel kaydedildi",
  [Key.preview]: "Önizleme",
  [Key.exportData]: "JSON dışa aktar",
  [Key.importData]: "JSON içe aktar",
  [Key.resetData]: "Verileri sıfırla",
  [Key.newItem]: "Yeni",
  [Key.deleteItem]: "Sil",
  [Key.edit]: "Düzenle",
  [Key.title]: "Başlık",
  [Key.description]: "Açıklama",
  [Key.body]: "Markdown",
  [Key.date]: "Tarih",
  [Key.status]: "Durum",
  [Key.draft]: "Taslak",
  [Key.published]: "Yayımlandı (demo)",
  [Key.settings]: "Ayarlar",
  [Key.overview]: "Genel bakış",
  [Key.media]: "Medya",
  [Key.upload]: "Resim yükle",
  [Key.dataTools]: "Veri araçları",
  [Key.saveError]: "Kaydedilemedi. Depolamayı kontrol edin.",
  [Key.invalidData]: "Geçersiz veri; mevcut veriler değişmedi.",
  [Key.confirmDelete]: "Silinsin mi? Önce referansları güncelleyin.",
  [Key.confirmReset]: "Yerel düzenlemeler ve medya sıfırlansın mı?",
  [Key.password]: "Parola",
  [Key.unlock]: "Kilidi aç",
  [Key.unlockError]: "Yanlış parola",
  [Key.empty]: "Öğe yok",
  [Key.back]: "Geri",
  [Key.next]: "Sonraki",
  [Key.previous]: "Önceki",
  [Key.searchPlaceholder]: "Yazı ara…",
  [Key.localOnly]: "Yalnızca yerel önizleme",
  [Key.storage]: "Depolama",
  [Key.details]: "Ayrıntılar",
  [Key.add]: "Ekle",
  [Key.remove]: "Kaldır",
  ...
  [Key.searchError]: "Arama kullanılamıyor. Tekrar deneyin.",
  [Key.enable]: "Etkinleştir",
  [Key.progress]: "İlerleme",
  [Key.adminContent]: "İçerik",
  [Key.adminOrganize]: "Düzenleme",
  [Key.adminMediaDescription]: "İçerikte kullanılan yerel görselleri yönetin.",
  [Key.adminUploadHint]:
    "JPG, PNG, GIF, WebP veya AVIF, en fazla 20 MB. Otomatik yüklenir.",
  [Key.adminChooseImages]: "Görsel seç",
  [Key.adminCleanUnused]: "Kullanılmayan görselleri sil",
  [Key.adminCleanConfirm]:
    "Referansı olmayan tüm yerel görseller silinsin mi? Geri alınamaz.",
  [Key.adminReferenced]: "Kullanılan görseller silinemez",
  [Key.adminReferenceCount]: "{count} öğede kullanılıyor",
  [Key.adminOverviewIntro]: "İçeriğinize genel bakış.",
  [Key.adminRecentHint]: "İçerik tarihine göre makaleler.",
  [Key.adminQuickActions]: "Hızlı işlemler",
  [Key.adminModuleHint]: "Kategorileri ve sayfaları yönetin",
  [Key.adminMediaSearch]: "Dosya adı ara",
  [Key.adminGridView]: "Izgara görünümü",
  [Key.adminListView]: "Liste görünümü",
  [Key.adminMediaTotal]: "{count} görsel",
  [Key.adminCopyReference]: "Referansı kopyala",
};
