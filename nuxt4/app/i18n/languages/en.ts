...
export const en: Translation = {
  ...
  [Key.explore]: "Explore",
  [Key.theme]: "Theme",
  [Key.skipContent]: "Skip to content",
  [Key.localNotice]:
    "Local demo. Changes affect this browser only; the public site is unchanged.",
  [Key.saveLocal]: "Save locally",
  [Key.savedLocal]: "Saved locally",
  [Key.preview]: "Preview",
  [Key.exportData]: "Export JSON",
  [Key.importData]: "Import JSON",
  [Key.resetData]: "Reset data",
  [Key.newItem]: "New item",
  [Key.deleteItem]: "Delete",
  [Key.edit]: "Edit",
  [Key.title]: "Title",
  ...
  [Key.status]: "Status",
  [Key.draft]: "Draft",
  [Key.published]: "Published (demo)",
  [Key.settings]: "Settings",
  [Key.overview]: "Overview",
  [Key.media]: "Media",
  [Key.upload]: "Upload image",
  [Key.dataTools]: "Data tools",
  [Key.saveError]: "Could not save. Check browser storage.",
  [Key.invalidData]: "Invalid data; existing data was not changed.",
  [Key.confirmDelete]:
    "Delete this item? Referenced content must be updated first.",
  [Key.confirmReset]: "Reset all local edits and media?",
  [Key.password]: "Password",
  [Key.unlock]: "Unlock",
  [Key.unlockError]: "Incorrect password",
  [Key.empty]: "No items",
  [Key.back]: "Back",
  [Key.next]: "Next",
  [Key.previous]: "Previous",
  [Key.searchPlaceholder]: "Search articles…",
  [Key.localOnly]: "Local preview only",
  [Key.storage]: "Storage",
  [Key.details]: "Details",
  [Key.add]: "Add",
  [Key.remove]: "Remove",
  ...
  [Key.searchError]: "Search unavailable. Please try again.",
  [Key.enable]: "Enable",
  [Key.progress]: "Progress",
  [Key.adminContent]: "Content",
  [Key.adminOrganize]: "Organization",
  [Key.adminMediaDescription]: "Manage local images used by your content.",
  [Key.adminUploadHint]:
    "JPG, PNG, GIF, WebP or AVIF, up to 20 MB. Images upload automatically.",
  [Key.adminChooseImages]: "Choose images",
  [Key.adminCleanUnused]: "Clean unused images",
  [Key.adminCleanConfirm]:
    "Delete all unreferenced local images? This cannot be undone.",
  [Key.adminReferenced]: "Used images cannot be deleted",
  [Key.adminReferenceCount]: "Used by {count} items",
  [Key.adminOverviewIntro]: "Your content, at a glance.",
  [Key.adminRecentHint]: "Articles ordered by content date.",
  [Key.adminQuickActions]: "Quick actions",
  [Key.adminModuleHint]: "Browse and organize your content",
  [Key.adminMediaSearch]: "Search filenames",
  [Key.adminGridView]: "Grid view",
  [Key.adminListView]: "List view",
  [Key.adminMediaTotal]: "{count} images",
  [Key.adminCopyReference]: "Copy reference",
};
