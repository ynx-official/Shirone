...
export const ja: Translation = {
  ...
  [Key.skipContent]: "本文へ",
  [Key.localNotice]:
    "ローカルデモ：変更はこのブラウザのみ。公開サイトは変更されません。",
  [Key.saveLocal]: "ローカル保存",
  [Key.savedLocal]: "保存しました",
  [Key.preview]: "プレビュー",
  [Key.exportData]: "JSON 書き出し",
  [Key.importData]: "JSON 読み込み",
  [Key.resetData]: "データをリセット",
  [Key.newItem]: "新規",
  [Key.deleteItem]: "削除",
  [Key.edit]: "編集",
  [Key.title]: "タイトル",
  [Key.description]: "説明",
  [Key.body]: "Markdown 本文",
  [Key.date]: "日付",
  [Key.status]: "状態",
  [Key.draft]: "下書き",
  [Key.published]: "公開済み（デモ）",
  [Key.settings]: "設定",
  [Key.overview]: "概要",
  [Key.media]: "メディア",
  [Key.upload]: "画像をアップロード",
  [Key.dataTools]: "データ管理",
  [Key.saveError]: "保存できません。ストレージを確認してください。",
  [Key.invalidData]: "無効なデータです。元のデータは変更されていません。",
  [Key.confirmDelete]: "削除しますか？参照を先に更新してください。",
  [Key.confirmReset]: "すべてのローカル編集と画像をリセットしますか？",
  [Key.password]: "パスワード",
  [Key.unlock]: "解除",
  [Key.unlockError]: "パスワードが違います",
  [Key.empty]: "項目なし",
  [Key.back]: "戻る",
  [Key.next]: "次へ",
  [Key.previous]: "前へ",
  [Key.searchPlaceholder]: "記事を検索…",
  [Key.localOnly]: "ローカルプレビューのみ",
  [Key.storage]: "ストレージ",
  [Key.details]: "詳細",
  [Key.add]: "追加",
  [Key.remove]: "除去",
