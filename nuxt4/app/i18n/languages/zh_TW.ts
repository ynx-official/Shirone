...
export const zh_TW: Translation = {
  ...
  [Key.explore]: "探索",
  [Key.theme]: "主題",
  [Key.skipContent]: "跳至內文",
  [Key.localNotice]: "本機示範：修改僅影響目前瀏覽器，公開網站保持不變。",
  [Key.saveLocal]: "儲存至本機",
  [Key.savedLocal]: "已儲存至本機",
  [Key.preview]: "預覽",
  [Key.exportData]: "匯出 JSON",
  [Key.importData]: "匯入 JSON",
  [Key.resetData]: "重設資料",
  [Key.newItem]: "新增",
  [Key.deleteItem]: "刪除",
  [Key.edit]: "編輯",
  [Key.title]: "標題",
  [Key.description]: "描述",
  [Key.body]: "Markdown 內文",
  [Key.date]: "日期",
  [Key.status]: "狀態",
  [Key.draft]: "草稿",
  [Key.published]: "已發布（示範）",
  [Key.settings]: "設定",
  [Key.overview]: "總覽",
  [Key.media]: "媒體",
  [Key.upload]: "上傳圖片",
  [Key.dataTools]: "資料工具",
  [Key.saveError]: "儲存失敗，請檢查瀏覽器儲存空間。",
  [Key.invalidData]: "資料無效，原有資料未變更。",
  [Key.confirmDelete]: "刪除此項？請先處理引用關係。",
  [Key.confirmReset]: "重設全部本機修改與媒體？",
  [Key.password]: "密碼",
  [Key.unlock]: "解鎖",
  [Key.unlockError]: "密碼錯誤",
  [Key.empty]: "暫無內容",
  [Key.back]: "返回",
  [Key.next]: "下一頁",
  [Key.previous]: "上一頁",
  [Key.searchPlaceholder]: "搜尋文章…",
  [Key.localOnly]: "僅本機預覽",
  [Key.storage]: "儲存空間",
  [Key.details]: "詳情",
  [Key.add]: "加入",
  ...
  [Key.cancel]: "取消",
  [Key.copyCode]: "複製程式碼",
  [Key.searchError]: "搜尋暫不可用，請重試。",
  [Key.enable]: "啟用",
  [Key.progress]: "進度",
  [Key.adminContent]: "內容",
  [Key.adminOrganize]: "組織",
  [Key.adminMediaDescription]: "管理正文圖片；上傳的圖片儲存在目前瀏覽器中。",
  [Key.adminUploadHint]:
    "JPG、PNG、GIF、WebP 或 AVIF，最大 20 MB；選擇後自動上傳。",
  [Key.adminChooseImages]: "選擇圖片",
  [Key.adminCleanUnused]: "清理未引用圖片",
  [Key.adminCleanConfirm]: "刪除所有未引用的本機圖片？此操作無法復原。",
  [Key.adminReferenced]: "使用中的圖片無法刪除",
  [Key.adminReferenceCount]: "引用 {count} 項",
  [Key.adminOverviewIntro]: "查看內容近況，繼續你的創作。",
  [Key.adminRecentHint]: "按內容日期查看近期文章。",
  [Key.adminQuickActions]: "常用操作",
  [Key.adminModuleHint]: "管理內容分類與擴充頁面",
  [Key.adminMediaSearch]: "搜尋檔案名稱",
  [Key.adminGridView]: "網格檢視",
  [Key.adminListView]: "清單檢視",
  [Key.adminMediaTotal]: "共 {count} 張圖片",
  [Key.adminCopyReference]: "複製引用",
};
