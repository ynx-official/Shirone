enum I18nKey {
  ...
  gamesNoResults = "gamesNoResults",
  gamesSearchPlaceholder = "gamesSearchPlaceholder",
  ...
  adminOrganize = "adminOrganize",
  adminMediaDescription = "adminMediaDescription",
  adminUploadHint = "adminUploadHint",
  adminChooseImages = "adminChooseImages",
  adminCleanUnused = "adminCleanUnused",
  adminCleanConfirm = "adminCleanConfirm",
  adminReferenced = "adminReferenced",
  adminReferenceCount = "adminReferenceCount",
  adminOverviewIntro = "adminOverviewIntro",
  adminRecentHint = "adminRecentHint",
  adminQuickActions = "adminQuickActions",
  adminModuleHint = "adminModuleHint",
  adminMediaSearch = "adminMediaSearch",
  adminGridView = "adminGridView",
  adminListView = "adminListView",
  adminMediaTotal = "adminMediaTotal",
  adminCopyReference = "adminCopyReference",
}
